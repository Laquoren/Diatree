...
lbxglu = float(input("Please enter plasma glucose results (mmol/L): "))
lbxtc = float(input("Please enter total cholesterol results (mg/dL): "))
bmxwt = float(input("Please enter weight (kg): "))
bmxbmi = float(input("Please enter body mass index (BMI): "))
bmxht = float(input("Please enter standing height (cm): "))
bmxwaist = float(input("Please enter waist circumference (cm): "))
